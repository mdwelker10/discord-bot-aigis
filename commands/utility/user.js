...
module.exports = {
  ...
  async execute(interaction) {
    ...
    await interaction.reply(`Allow me to dox you. Your username is ${interaction.user.tag}-san, but you prefer to be called ${interaction.user.displayName}. You joined the server on ${numToMonth(month)} ${date}, ${year}. It was a ${numToDate(day)}.`);
  },
};
